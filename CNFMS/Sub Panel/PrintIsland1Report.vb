...
Imports CNFMS.Island1Panel


Public Class PrintIsland1Report
    Public Shared rpt1 As New CrystalReportIsland1CutOff
    ...
    Private Sub TOTALLiters()
        Using sqlcommand As New MySqlCommand()
            With sqlcommand
                .CommandText = "SELECT SUM(LitersOut_Regular), SUM(LitersOut_Premium), SUM(LitersOut_Diesel) FROM island1_report WHERE Pump_name = @pumps AND DATE(Date_cutOff) BETWEEN @datepickerFrom AND @datepickerTo"
    ...
    Private Sub showCrystalFuelReport()
        Using sqlcommand1 As New MySqlCommand()
            ...
            Try
                ...
                rpt1.Database.Tables("island1_report").SetDataSource(dt)
                Island1Viewer.ReportSource = Nothing
                Island1Viewer.ReportSource = rpt1
                Dim TotalTxt1 As TextObject = DirectCast(rpt1.ReportDefinition.Sections("Section4").ReportObjects("TotalRegular"), TextObject)
                Dim TotalTxt2 As TextObject = DirectCast(rpt1.ReportDefinition.Sections("Section4").ReportObjects("TotalPremium"), TextObject)
                Dim TotalTxt3 As TextObject = DirectCast(rpt1.ReportDefinition.Sections("Section4").ReportObjects("TotalDiesel"), TextObject)
    ...
    Private Sub PrintIsland1Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TOTALLiters()
    ...
    Private Sub backButton_Click(sender As Object, e As EventArgs) Handles backButton.Click
        Dim Island1PanelShow As New Island1Panel
