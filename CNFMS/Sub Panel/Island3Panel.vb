...
Imports CNFMS.PrintIsland3Report
Imports Excel = Microsoft.Office.Interop.Excel

Public Class Island3Panel
    Dim dialog1 As DialogResult




    Public Shared Island3DateFrom As String = ""
    Public Shared Island3DateTo As String = ""
    Public Shared Island3PumpName As String = ""

    Public Shared PassDateFromIsland3 As String = ""
    Public Shared PassDateToIsland3 As String = ""
    ...
    Private Sub loadIsland1Report()
        Using sqlcommand As New MySqlCommand()
            ...
            With sqlcommand
                .CommandText = "SELECT Id, Pump_name, Date_cutOff, LitersOut_Regular, LitersOut_Premium, LitersOut_Diesel, CONCAT('₱ ', FORMAT(Price_Regular,2)) AS Price_Regular, CONCAT('₱ ', FORMAT(Price_Premium,2)) AS Price_Premium, CONCAT('₱ ', FORMAT(Price_Diesel,2)) AS Price_Diesel FROM island3_report WHERE DATE(Date_cutOff) = @datepickerTo"
            ...
            Try
                ...
                island3Table.DataSource = dataTables
            Catch ex As Exception
    ...
    Private Sub filterShowAll()
        Using sqlcommand As New MySqlCommand()
            ...
            With sqlcommand
                .CommandText = "SELECT Id, Pump_name, Date_cutOff, 	LitersOut_Regular, 	LitersOut_Premium, 	LitersOut_Diesel, CONCAT('₱ ', FORMAT(Price_Regular,2)) AS Price_Regular, CONCAT('₱ ', FORMAT(Price_Premium,2)) AS Price_Premium, CONCAT('₱ ', FORMAT(Price_Diesel,2)) AS Price_Diesel FROM island3_report"
                .Connection = SQLString
            End With
            Try
                dataAdapter.SelectCommand = sqlcommand
    ...
    Private Sub Island3Panel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub filterButton_Click(sender As Object, e As EventArgs) Handles filterButton.Click
        ...
        Else
            filterInventory()
            Island3PumpName = pumpComboBox.SelectedItem.ToString()
        End If

    End Sub

    Private Sub addFuelButton_Click(sender As Object, e As EventArgs) Handles addFuelButton.Click
        AddIsland3Report.Show()
    End Sub

    Private Sub DateTimePickerFrom_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePickerFrom.ValueChanged
        Island3DateFrom = DateTimePickerFrom.Value.ToString("MMM. dd, yyyy")
        PassDateFromIsland3 = DateTimePickerFrom.Value.ToString("yyyy-MM-dd")
    End Sub

    Private Sub DateTimePickerTo_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePickerTo.ValueChanged
        Island3DateTo = DateTimePickerTo.Value.ToString("MMM. dd, yyyy")
        PassDateToIsland3 = DateTimePickerTo.Value.ToString("yyyy-MM-dd")
    End Sub
    Private Sub showreportPanel()
        Dim ShowReportIsland3 As New PrintIsland3Report
        MainPanel.FillPanel.Size = MainPanel.FillPanel.MaximumSize
        ShowReportIsland3.Dock = DockStyle.Fill
        MainPanel.FillPanel.Controls.Clear()
        MainPanel.FillPanel.Controls.Add(ShowReportIsland3)
    End Sub
    Private Sub PrintButton_Click(sender As Object, e As EventArgs) Handles PrintButton.Click
        ...
        Else
            ...
            If PrintDialog.ShowDialog = Windows.Forms.DialogResult.OK Then
                rpt3.PrintOptions.PrinterName = PrintDialog.PrinterSettings.PrinterName
                rpt3.PrintToPrinter(PrintDialog.PrinterSettings.Copies, PrintDialog.PrinterSettings.Collate, PrintDialog.PrinterSettings.FromPage, PrintDialog.PrinterSettings.ToPage)
            End If
        End If
    ...
    Private Sub exportPDFButton_Click(sender As Object, e As EventArgs) Handles exportPDFButton.Click
        ...
        Else
            showreportPanel()
            Dim exportIsland3 As New PrintIsland3Report
            exportIsland3.export_pdf_format()
        End If
    End Sub
    ...
    Private Sub exportExcelButton_Click(sender As Object, e As EventArgs) Handles exportExcelButton.Click
        ...
        Else
            Using sqlcommand As New MySqlCommand()
                ...
                Dim dateTo = DateTimePickerTo.Value.ToString("yyyy-MM-dd")
                With sqlcommand
                    .CommandText = "SELECT Id, Pump_name, Date_cutOff, LitersOut_Regular, LitersOut_Premium, LitersOut_Diesel, Price_Regular, Price_Premium, Price_Diesel FROM island3_report WHERE Pump_name = @pumps AND DATE(Date_cutOff) BETWEEN @datepickerFrom AND @datepickerTo"
                    .Parameters.AddWithValue("pumps", pumpComboBox.SelectedItem.ToString)
                    .Parameters.AddWithValue("@datepickerFrom", dateFrom)
                    .Parameters.AddWithValue("@datepickerTo", dateTo)
                    .Connection = SQLString
                ...
                Try
                    ...
                    Try
                        If f.ShowDialog() = DialogResult.OK Then
                            ...
                            'Set final path
                            Dim fileName As String = "\CN ISLAND3 CUT-OFF Report" + ".xls"
    ...
    Private Sub island3Table_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles island3Table.CellContentClick
        Try
            Dim selecteddata As DataGridViewRow = island3Table.Rows(e.RowIndex)
            If island3Table.Columns(e.ColumnIndex).Name = "updateData" Then
                    ...
                    If dialog1 = DialogResult.OK Then
                        ...
                        Using sqlcommandDelete1 As New MySqlCommand()
                            With sqlcommandDelete1
                                .CommandText = "DELETE FROM `island3_report` WHERE Id = @delID"
                        ...
                        Using sqlcommandDelete2 As New MySqlCommand()
                            With sqlcommandDelete2
                                .CommandText = "DELETE FROM `island3_cashsale` WHERE Id = @delID"
                                .Parameters.AddWithValue("@delID", selectedID)
                                .Connection = SQLString
                                Try
