...
Public Class EmployeeInformation
            ...
            Try
                ...
                Using dataReader As MySqlDataReader = sqlcommand.ExecuteReader
                    If dataReader.Read Then
                        employmentIDTxt.Text = dataReader.GetString(0)
                        ...
                        jobTxt.Text = dataReader.GetString(4)
    ...
    Private Sub EmployeeInformation_Load(sender As Object, e As EventArgs) Handles Me.Load
        showFuelInfo()
    End Sub
            ...
            Try
                ...
                Using sqlcommand As New MySqlCommand()
                    ...
                    Try
                        ...
                        MainPanel.FillPanel.Controls.Add(EmployeePanelShow)
