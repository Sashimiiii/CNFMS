Public Class CutOff_Panel
    ...
    Public Sub ShadowPanel1_MouseClick(sender As Object, e As MouseEventArgs) Handles ShadowPanel1.MouseClick
        ShadowPanel1.ShadowShift = 10
        Dim ShowIsland1 As New Island1Panel
    ...
    Public Sub ShadowPanel2_MouseClick(sender As Object, e As MouseEventArgs) Handles ShadowPanel2.MouseClick
        ShadowPanel2.ShadowShift = 10
        Dim ShowIsland2 As New island2Panel
        MainPanel.FillPanel.Size = MainPanel.FillPanel.MaximumSize
    ...
    Public Sub ShadowPanel3_MouseClick(sender As Object, e As MouseEventArgs) Handles ShadowPanel3.MouseClick
        ShadowPanel3.ShadowShift = 10
        Dim ShowIsland3 As New Island3Panel
        MainPanel.FillPanel.Size = MainPanel.FillPanel.MaximumSize
