...
Public Class AddIsland3Report
    ...
    Private Sub AddIsland3Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub saveButton_Click(sender As Object, e As EventArgs) Handles saveButton.Click
        ...
        Else
            Try
                ...
                Using sqlcommand As New MySqlCommand()
                    With sqlcommand
                        .CommandText = "INSERT INTO island3_report (Pump_name, Date_cutOff, LitersOut_Regular, LitersOut_Premium, LitersOut_Diesel, Price_Regular, Price_Premium, Price_Diesel) 
                ...
                Using sqlcommand2 As New MySqlCommand()
                    ...
                    With sqlcommand2
                        .CommandText = "INSERT INTO island3_cashsale (Pump_name, Date_CutOff, SalesRegular, SalesPremium, SalesDiesel, Total_Sale, Price_Regular, Price_Premium, Price_Diesel) 
                                values (@pumpname, @dateSet, @regular, @premium, @diesel, @TotalSaless, @p_regular, @p_premium, @p_diesel)"
                        .Parameters.AddWithValue("@pumpname", pumpCombox.SelectedItem.ToString)
                        .Parameters.AddWithValue("@dateSet", dateText)
                        ...
                        .Parameters.AddWithValue("@TotalSaless", TotalSaleTXT)
                        .Parameters.AddWithValue("@p_regular", regularTxt)
                        .Parameters.AddWithValue("@p_premium", premiumTxt)
                        .Parameters.AddWithValue("@p_diesel", dieselTxt)
                        .Connection = SQLString
                ...
                AddIsland3Report_Load(sender, e)
                showCutOffPanel.ShadowPanel3_MouseClick(sender, e)
                litersOutTxt1.Text = ""
                litersOutTxt2.Text = ""
                litersOutTxt3.Text = ""
                Me.Close()
