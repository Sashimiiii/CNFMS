...
Public Class AddIsland2Report
    ...
    Private Sub showFuelInfo()
        ...
        End Using
    End Sub
    Private Sub AddIsland2Report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub saveButton_Click(sender As Object, e As EventArgs) Handles saveButton.Click
        ...
        Else
            Try
                ...
                Using sqlcommand As New MySqlCommand()
                    With sqlcommand
                        .CommandText = "INSERT INTO island2_report (Pump_name, Date_cutOff, LitersOut_Regular, LitersOut_Premium, LitersOut_Diesel, Price_Regular, Price_Premium, Price_Diesel) 
                ...
                Using sqlcommand2 As New MySqlCommand()
                    ...
                    With sqlcommand2
                        .CommandText = "INSERT INTO island2_cashsale (Pump_name, Date_CutOff, SalesRegular, SalesPremium, SalesDiesel, Total_Sale, Price_Regular, Price_Premium, Price_Diesel) 
                ...
                AddIsland2Report_Load(sender, e)
                showCutOffPanel.ShadowPanel2_MouseClick(sender, e)
                litersOutTxt1.Text = ""
                litersOutTxt2.Text = ""
                litersOutTxt3.Text = ""
                Me.Close()
